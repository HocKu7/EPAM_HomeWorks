...
public class Application {
  ...
  public static void main(String[] args) {
    ...
    //demoSortOperations();
    doIndexNotFoundException();
  }
  private static void doIndexNotFoundException(){
    cargoService.deleteById(1L);
    System.out.println("Try delete again");
    cargoService.deleteById(1L);

    System.out.println("1");
    transportationService.deleteById(14L);
    System.out.println("2");
    transportationService.deleteById(14L);

    System.out.println("3");
    carrierService.deleteById(7L);
    System.out.println("4");
    carrierService.deleteById(7L);
    System.out.println("5");

    cargoService.deleteById(1121231L);
    System.out.println("6");
    transportationService.deleteById(12312312L);
    System.out.println("7");
    carrierService.deleteById(12312312312L);
  }
